...
const ThemeToggle = () => {
  ...
  return (
    <button
      ...
      className="flex w-full items-center justify-between rounded-lg border border-sidebar-border bg-sidebar-accent/80 px-3 py-2 text-sm text-sidebar-foreground transition hover:border-sidebar-primary hover:bg-sidebar-primary/10"
